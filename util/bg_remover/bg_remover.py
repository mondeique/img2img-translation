...
import tqdm
import logging
from util.bg_remover.libs.strings import *
from util.bg_remover.libs.networks import model_detect
import util.bg_remover.libs.preprocessing as preprocessing
import util.bg_remover.libs.postprocessing as postprocessing
...
def cli(input_path):
    ...
    if model_name == "test":
        print(input_path, model_name, preprocessing_method_name, postprocessing_method_name)
    else:
        process(input_path, model_name, preprocessing_method_name, postprocessing_method_name)
